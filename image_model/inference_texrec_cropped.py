...
###############################################################################
# Paths
DATA_DIR = "/cluster/home/muhamhz/data/DataTexRecSSH/cropped_images"  # Updated to new directory
RESULTS_BASE_DIR = "/cluster/home/muhamhz/data/DataTexRecSSH/cropped_images/results"  # Ensure results are saved in a subfolder
LOGS_DIR = "/cluster/home/muhamhz/JPDVT/image_model/logs/cropped_images"  # Updated logs directory
...
def main():
    ...
    logging.info(f"Found {len(image_paths)} images in {DATA_DIR} (masks excluded).")
    ...
    logging.info("============================================")
    logging.info(f"Processed {total_count} images (including resumed ones).")
