...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.time_emb_in = nn.Linear(8,768)
        self.time_emb_out1 = nn.Linear(768,64)
        self.time_emb_out_silu = nn.SiLU()
        self.time_emb_out2 = nn.Linear(64,8)
    ...
    def initialize_weights(self):
        ...
        nn.init.normal_(self.time_emb_in.weight, std=0.02)
        nn.init.normal_(self.time_emb_out1.weight, std=0.02)
